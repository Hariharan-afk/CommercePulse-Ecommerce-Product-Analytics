CREATE OR REPLACE TABLE mart_monthly_smartphone_price_band_performance AS

WITH smartphone_price_band_events AS (
    SELECT
        event_month,
...
smartphone_price_band_session_steps AS (
    SELECT
        event_month,
...
smartphone_price_band_funnel AS (
    SELECT
        event_month,
        price_band_order,
        price_band,
    ...
    FROM smartphone_price_band_session_steps
    GROUP BY
        event_month,
        price_band_order,
        price_band
...
FROM smartphone_price_band_events e
LEFT JOIN smartphone_price_band_funnel f
